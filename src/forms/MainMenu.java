...
public class MainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Consolidador");
        setName(""); // NOI18N
        setResizable(false);

        labelTitle.setText("Consolidar Quantidade de Transações do Universo Ourocard");
        ...
        labelStep2.setText("Passo 2 - Consolidar:");

        buttonStep2.setText("Consolidar");
        ...
        labelSubtitle.setText("MULTI x BOP x ANALYZER");
    ...
    private void fileChooserInstance() {
        ...
        FileNameExtensionFilter filter = new FileNameExtensionFilter("Arquivos do Microsoft Excel", "xlsx", "xls");
